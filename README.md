...
Supongamos que desarrollas Web y no te gusta hacer estilos (CSS) entonces programas tus funciones para que cuando tu agregues ciertas lineas a tu código tu página sea responsiva. Entoncesentonces apoyado de tu Framework haces los cálculos necesarios, tomas en cuenta todos los posibles casos, las medidas y después de mucho trabajo lo logras. Ahora cuando quieres estilos simplemente tomas y lo implementas que podría ser un Boostrap.
